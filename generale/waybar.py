...
class Player:
    ...
    def name(self):
        ...
        if name == 'plasma-browser-integration-host':
            cmdline = ' '.join(self.owner_process.cmdline()) return self._identify_browser_by_cmdline(cmdline) return name
    ...
    def _find_players(self):
        ...
        for service in KNOWN_SERVICES:
            try:
                ...
                continue
            owner_to_player[owner_name] = Player(
                bus=self._bus, owner_name=owner_name
            )
